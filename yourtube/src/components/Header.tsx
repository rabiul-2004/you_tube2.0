...
const Header = ({
  ...
  return (
    <header className="sticky top-0 z-40 flex items-center justify-between px-4 py-2 bg-white border-b h-14">
      ...
      <form
        ...
        className="flex items-center flex-1 max-w-2xl mx-2 sm:mx-4"
      >
        <div className="flex flex-1">
          ...
          <Button
            type="submit"
            className="rounded-r-full px-4 sm:px-6 bg-gray-50 hover:bg-gray-100 text-gray-600 border border-l-0 h-9"
          >
            <Search className="w-4 h-4" />
          </Button>
        </div>
        <Button variant="ghost" size="icon" className="rounded-full ml-2 shrink-0 hidden sm:flex">
